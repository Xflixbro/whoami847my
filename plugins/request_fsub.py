        ...
        try:
            if selected_image:
                ...
                await client.edit_message_text(
                    ...
                    message_effect_id=random.choice(MESSAGE_EFFECT_IDS)  # Effect only here
                )
        except Exception as e:
        ...
        try:
            if selected_image:
                ...
                await callback.message.reply(
                    "<blockquote><b>Pʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ɪᴅ ᴏʟ ᴜsᴇʀɴᴀᴍᴇ ᴛᴏ ᴀᴅᴅ ғᴏʀ ғᴏʀᴄᴇ-sᴜʙ.</b></blockquote>\n"
                    "<blockquote><b>Eɴsᴜʀᴇ ᴛʜᴇ ʙᴏᴛ ɪs ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜᴀᴛ ᴄʜᴀɴɴᴇʟ.</b></blockquote>\n"
                    "<blockquote><b>Eɴᴛᴇʀ ᴏɴᴇ ᴄʜᴀɴɴᴇʟ ᴀᴛ ᴀ ᴛɪᴍᴇ.</b></blockquote>\n\n"
                    "<b>E x ᴀ ᴍ ᴘ ʟ ᴇ:</b>\n"
                    "<code>-100XXXXXXXXXX</code>\n"
        ...
        try:
            ...
            try:
                if selected_image:
                    ...
                    await message.reply(
                        f"<blockquote><b>✅ Fᴏʀᴄᴇ-sᴜʬ Cʜᴀɴɴᴇʟ ᴀᴅᴅᴇᴅ sᴜᴄᴄᴇssғᴜʬʲʟʟʏ!</b></blockquote>\n\n"
                        f"<blockquote><b>Nᴀᴍᴇ:</b> <a href='{link}'>{chat.title}</a></blockquote>\n"
                        f"<blockquote><b>Iᴅ:</b></blockquote>\n <code>{channel_id}</code>",
                        parse_mode=ParseMode.HTML,
                        disable_web_page_preview=True
...
async def add_force_sub(client: Client, message: Message):
    ...
    try:
        ...
        try:
            ...
            await temp.edit(
                f"<blockquote><b>✅ Fᴏʤʀᴄᴇ-sᴜʬ Cʜᴀɴɴᴇʟ ᴀᴅᴅᴇᴅ sᴜᴄᴄᴇssғᴜʬʲʟʟʏ!</b></blockquote>\n\n"
                f"<blockquote><b>Nᴀᴍᴇ:</b> <a href='{link}'>{chat.title}</a></blockquote>\n"
                f"<blockquote><b>Iᴅ:</b></blockquote>\n <code>{channel_id}</code>",
                disable_web_page_preview=True,
                parse_mode=ParseMode.HTML
            ...
            if selected_image:
                await temp.edit_media(
                    media=InputMediaPhoto(
                        media=selected_image,
                        caption=(
                            f"<blockquote><b>✅ Fᴏʤʀᴄᴇ-sᴜʬ Cʜᴀɴɴᴇʟ ʀᴇᴍᴏᴠᴇᴅ sᴜᴄᴄᴇssғᴜʬʲʟʟʏ!</b></blockquote>\n\n"
    ...
    if not channels:
        try:
            if selected_image:
                await message.reply_photo(
                    photo=selected_image,
                    caption="<b>Nᴏ ᴄʜᴀɴɴᴇʟs ᴄᴏɴғɪɢᴜʀᴇᴅ ғᴏʀ ғᴏʀᴄᴇ-sᴜʬ.</b>",
                    parse_mode=ParseMode.HTML
                )
            else:
                await message.reply(
            ...
            await message.reply(
                "<b>Nᴏ ᴄʜᴀɴɴᴇʟs ᴄᴏɴғɪɢᴜʀᴇᴅ ғᴏʀ ғᴏʤʀᴄᴇ-sᴜʬ.</b>",
                parse_mode=ParseMode.HTML
            )
        return

    settings_text = "<b>›› Fᴏʤʀᴄᴇ-Sᴜʬ Cʜᴀɴɴᴇʟs:</b>\n\n"
    for ch_id in channels:
        try:
            chat = await client.get_chat(ch_id)
            link = await client.export_chat_invite_link(ch_id) if not chat.username else f"https://t.me/{chat.username}"
