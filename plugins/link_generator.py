...
async def flink_input_filter(client: Client, __: None, message: Message) -> bool:
    ...
    logger.info(f"flink_input_filter for user {user_id}: state={state}")
    return state and (message.forwarded or re.match(r"^https?://t\.me/.*$", message.text or ""))
...
async def handle_batch_input(client: Client, message: Message):
    """Handle input for batch command based on input."""
    user_id = message.from_user.id
    ...
    try:
        if state == 'awaiting_first_message':
            ...
            string = f"get-{f_msg_id * abs(client.db_id)}-{s_msg_id * abs(client.db_id)}"
        ...
        await message.reply_text(
            to_small_caps_with_html(
                "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n"
                "<blockquote><b>❅ Timeout: No response received.</b></blockquote>\n"
                "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"
            ),
            parse_mode=ParseMode.HTML
        )
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                await message.reply_text(
                    to_small_caps_with_html(
                        f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n"
                        f"<blockquote><b>❅ Failed to store a message:</b></blockquote>\n"
                        f"<code>{e}</code>\n"
                        f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"
                    ),
                    parse_mode=ParseMode.HTML
        ...
        if not collected:
            await message.reply_text(
                to_small_caps_with_html(
                    "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n"
                    "<blockquote><b>❅ No messages were added to batch.</b></blockquote>\n"
                    "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"
                ),
                parse_mode=ParseMode.HTML
            )
...
@Bot.on_message(filters.private & filters.create(flink_input_filter))
    ...
    try:
        ...
        if edit_data.get('image'):
            ...
            output_msg = await message.reply(
                text=caption if caption else to_small_caps_with_html(
                    "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n"
