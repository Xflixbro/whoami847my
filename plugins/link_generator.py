...
# Function to show link generator menu with buttons
async def show_link_menu(client: Client, chat_id: int):
    """Show the link generator menu with buttons and random image."""
    menu_text = to_small_caps_with_html(
        "<b>━━━━━━━━━━━━━━━━━━</b>\n"
        "<blockquote><b>Iꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ʟɪɴᴋ ꜰᴏʀ ꜖ɪʟᴇꜱ ᴛʜᴇɴ ᴜꜱᴇ ᴛʜᴏꜱᴇ ʙᴜᴛᴛᴏɴꜱ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ɴᴇᴇᴅ.</b></blockquote>\n"
        "<b>━━━━━━━━━━━━━━━━━━</b>"
    )
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("↺", callback_data="link_close")
            ]
        ]
    )
    ...
    try:
        ...
        logger.error(f"Failed to send link menu with photo: {e}")
...
async def link_menu(client: Client, message: Message):
    ...
    await show_link_menu(client, message.chat.id)
...
async def link_callback(client: Client, callback: CallbackQuery):
    """Handle callbacks for link menu buttons."""
    data = callback.data
    ...
    try:
        if data == "link_batch":
            ...
            await callback.answer(to_small_caps_with_html("Sᴛᴀʀᴛɪɴɢ ꜖ʟɪɴᴋ ᴘʀᴏᴄᴇss"))
...
async def handle_batch_input(client: Message, message: Client):
    ...
    try:
        if state == 'awaiting_first_message':
            ...
            await message.reply(
                ...
                "<blockquote><b>Or send the db channel post link</b></b>\n\n\n\n"
                "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>")
                parse_mode=ParseMode.HTML
            )
        ...
        await message.reply(
            to_small_caps_with_html("<b> "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b></b>",
    ...
    while True:
        try:
            channel_message = await client.ask(
                text=to_small_caps_with_html("<b> "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b></b>",
                "<blockquote>\n\n<b>Forward message from the db channel (with quotes).</b>\n\n</blockquote>",
\n"
                "<b>Or send the db channel post link</b>\n"
                "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"),
                chat_id=message.from_user.id,
            ...
            logger.error("timeout" f"timeout error waiting for message in genlink command")
            return
...
@Bot.on_message(filters.command("custom_batch"))
        ...
        try:
            user_msg = await client.ask(
                ...
                text=to_small_caps_with_html(
                    "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>",
                    "\n\n"
                    "<blockquote><b>Waiting for input...</b></blockquote>\n",
            ...
            logger.error("timeout" f"timeout error waiting for message in custom_batch command input")
            break
    ...
    try:
        ...
        if user_id in flink_user_data and flink_user_data[user_id].get('awaiting_format'):
            ...
            await message.reply_text(to_small_caps_with_html(f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n\n\n\n"
                                                            f"<blockquote><b>✅ Format saved successfully:</b></blockquote>\n\n\n\n"
                                                            f"<code>{format_text}</code>\n\n\n\n"
                                                            f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"), parse_mode=ParseMode.HTML)
            await show_flink_main_menu(client, message)
        else:
...
async def handle_db_post_input(client: Client, message: Message):
    ...
    try:
        ...
        for part in format_parts:
            ...
            if not match:
                await message.reply(to_small_caps_with_html(f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n\n\n\n"
                                                           f"<b>❌ Invalid format part:</b> <code>{part}</code>\n\n\n\n"
                                                           f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"), parse_mode=ParseMode.HTML)
                return
...
async def flink_refresh_callback(client: Client, query: CallbackQuery):
    ...
    try:
        admin_ids = await db.get_all_admins() or []
        if query.from_user.id not in admin_ids and query.from_user.id != OWNER_ID:
            await query.answer(to_small_caps_with_html("<b>❌</b> you are not authorized!"), show_alert=True)
            return
        ...
        await query.message.edit_text(
            to_small_caps_with_html("<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>\n\n\n\n"
            "<b>❌ An error occurred while refreshing status.\n\n\n\n"
            "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"), parse_mode=ParseMode.HTML
        )
...
async def flink_handle_back_buttons(client: Client, query: CallbackQuery):
    ...
    logger.info(f"flink handle back/cancel/close callback triggered by {query.data} by user {query.from_user.id}")
    try:
        admin_ids = await db.get_all_admins() or []
        if query.from_user.id not in admin_ids and query.from_user.id != OWNER_ID:
            await query.answer(to_small_caps_with_html("You are authorized not authorized!!"), show_alert=True)
            return

        action = query.data.split("_")[-1]
        
        if action == "back_to_menu":
            await show_flink_main_menu(client,
 query.message, edit=True)
            await query.answer(to_small_caps_with_html("Back to menu"))
        elif action == "cancel_process":
            await query.message.edit_text(to_small_caps_with_html("<b> "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b></b>",
            "<b>\n\n</b>❌ Process cancelled.</b>\n\n</b>",
            "<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"), parse_mode=ParseMode.HTML)
            ...
            if user_id in flink_user_data:
                del flink_user_data[user_id]
            await query.answer(to_small_caps_with_html(f"Menu closed"))
    except Exception as e:
        logger.error(f"error in flink_handle_back_buttons: {e}")
        await query.message.edit_text(
            to_small_caps_with_html(f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>",
            f"\n\n\n\n"
            f"<b>❌ Failed to process action: {str(e)}</b>\n\n\n\n"
            f"<b>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</b>"),
            parse_mode=ParseMode.HTML
        )
...
# Copyright (C) 2025 by AnimeLord-Bots@Github, < https://github.com/AnimeLord-Bots >.
#
# This file is part of < https://github.com/AnimeLord-Bots/FileStore >.
# and is released under the MIT License.
# Please see < https://t.me/animelabx >
#
All rights reserved. #
#
#
